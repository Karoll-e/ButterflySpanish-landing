...
export default function Hero() {
  return (
    <section className="relative ">
      ...
      <div className="container px-4 py-28 mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-12">
        <div className="lg:w-1/2 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 pt-4">
            <a href="#videos">
              <Button
                size="lg"
                className="group bg-rose-700 text-white hover:bg-rose-800"
              >
                Start Learning Now
