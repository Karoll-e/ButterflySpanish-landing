...
export default function Hero() {
  return (
    <section className="relative">
      ...
      <div className="container md:py-24 py-10 mx-auto relative z-10 flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2 space-y-8 px-4 md:px-0">
            <h1 className="text-5xl md:text-5xl lg:text-6xl font-semibold leading-[110%] md:tracking-tight text-balance">
              Learn{" "}
            ...
            <p className="text-xl md:text-xl opacity-90 text-zinc-800 md:text-balance">
